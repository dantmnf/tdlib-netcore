...
namespace TDLib.JsonClient
{
    ...
    {
        unsafe static class ImplX86
        {
#if X86_INTRINSICS
            public static readonly bool Supported = Sse42.IsSupported;
            public static readonly bool Supported64 = Sse42.X64.IsSupported;
#else
            public const bool Supported = false;
            public const bool Supported64 = false;
#endif
